...
input_dir = str(pathlib.Path(__file__).parent.resolve())+'/input/'  # The input directory of log file
output_dir = str(pathlib.Path(__file__).parent.resolve())+'/output'  # The output directory of parsing result
